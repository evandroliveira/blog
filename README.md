...
- git clone https://github.com/jaimevendrame/vagrant-setup-php.git ( Execute o comando no seu Prompt/Terminal )
...
2º -> Caso não tenha o Git instalado em sua máquina, acesse https://github.com/jaimevendrame/vagrant-setup-php baixe o arquivo do projeto no formato .zip e descompacte-o onde desejar.
